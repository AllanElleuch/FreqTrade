...
class LSv3(IStrategy):
    ...
    buy_long_fan_magnitude_shift_value = IntParameter(1, 6, default=3, space = "buy")
    buy_long_min_fan_magnitude_gain = DecimalParameter(1.000, 1.500, default=1.025, space = "buy")
    ...
    buy_short_min_fan_magnitude_gain = DecimalParameter(0.500, 1.000, default=0.975, space = "buy")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Trends magnitude
        conditions_long.append(dataframe['fan_magnitude_gain'] >= self.buy_long_min_fan_magnitude_gain.value)
        ...
        # Trends magnitude
        conditions_short.append(dataframe['fan_magnitude_gain'] <= self.buy_short_min_fan_magnitude_gain.value)
