...
class LSv1(IStrategy):
    ...
    exit_short_params = {
        "exit_short_indicator": "trend_close_1h",
    }
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.enter_long_params['buy_trend_bullish_level'] >= 2:
            conditions_long.append(dataframe['trend_close_15m'] > dataframe['trend_open_30m'])
        ...
        # Trends magnitude
        conditions_long.append(dataframe['fan_magnitude_gain'] >= self.enter_long_params['buy_min_fan_magnitude_gain'])
        ...
        if self.enter_short_params['short_trend_bearish_level'] >= 2:
            conditions_short.append(dataframe['trend_close_15m'] < dataframe['trend_open_30m'])
        ...
        # Trends magnitude
        conditions_short.append(dataframe['fan_magnitude_gain'] <= self.enter_short_params['short_min_fan_magnitude_gain'])
